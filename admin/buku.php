...
include'sidebar.php';
 ...
 <div class="main">
   <b><i class="fa fa-Book"></i>Book Data</b><a href="#" rel="tooltip" title="Tambah Data Buku"><button type="button" name="button" class="btn btn-secondary" style="margin-left:73%" onclick="document.getElementById('id01').style.display='block'" style="width:auto;"><i class="fa fa-fw fa-plus"></i></button>
...
<hr>
      ...
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="buku_rusak.php">Damaged</a>
        </li>
        <li class="nav-item">
